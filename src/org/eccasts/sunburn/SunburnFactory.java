...
public class SunburnFactory extends AbstractCandidateFactory<SunburnIndividual> {
    @Override
    public SunburnIndividual generateRandomCandidate(Random rng) {
        ...
        return new SunburnIndividual(slots, preferredRange);
    }
